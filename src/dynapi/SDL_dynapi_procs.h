...
SDL_DYNAPI_PROC(void,SetSDLVideoGLDriver,(const char *a),(),)
SDL_DYNAPI_PROC(void,UpdateEnableAngleState,(const bool a),(),)
...
SDL_DYNAPI_PROC(SDL_Scancode,TranslateKeycode,(int keycode),(keycode),return)
...
SDL_DYNAPI_PROC(void*,SDL_GetMouseVoid,(void),(),return)
SDL_DYNAPI_PROC(bool,SDL_GetRelativeMouseMode_Android,(void),(),return)
