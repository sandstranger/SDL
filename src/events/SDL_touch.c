    ...
    SDL_LockTouch();
    {
                    ...
                    if (window) {
                        if (down) {
                            if (finger_touching == false) {
                                ...
                                SDL_SendMouseButton(timestamp, window, SDL_TOUCH_MOUSEID, SDL_BUTTON_LEFT, true, invokePressEvents);
                            }
                        } else {
                            if (finger_touching == true && track_touchid == id && track_fingerid == fingerid) {
                                SDL_SendMouseButton(timestamp, window, SDL_TOUCH_MOUSEID, SDL_BUTTON_LEFT, false, invokePressEvents);
                            }
                        }
                    }
                    if (down) {
        ...
        if (down) {
            if (finger) {
                ...
                SDL_SendTouch(timestamp, id, fingerid, window, SDL_EVENT_FINGER_CANCELED, x, y, pressure, invokePressEvents);
            }
